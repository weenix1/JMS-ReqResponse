...
/**
 * Class Subscriber with some changes by Wolfgang Renz, May 2020
 * 
 ...
 */
class Subscriber extends JMSClient{
    // private String destination; //in super class initialized befor connect
    private MessageConsumer consumer;

    public Subscriber(String destination) throws JMSException
    {
        super(destination);
    ...
    public void receive() throws JMSException {
        ...
        System.err.println(this+ ": Listening ...");
        while(true) {
            ...
            if( msg instanceof TextMessage ) {
                ...
                if( !body.equals("EOT")) {
                    ...
                    System.err.println(this+ ": EOT arrived");
                    close();
                    break;
                }
